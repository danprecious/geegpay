...
const BottomNav = () => {
  ...
  return (
    <div className='fixed md:hidden text-center w-full bottom-0 flex justify-around px-2 py-3 align-middle min-h-[50px] rounded-t-md bg-white dark:bg-gray-700'>
